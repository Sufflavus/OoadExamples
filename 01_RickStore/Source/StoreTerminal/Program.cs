...
namespace RickStore.StoreTerminal
{
    class Program
    {
        ...
        {
            inventory.AddGuitar("V95693", 1499.95, Builder.Fender, "Stratocastor", GuitarType.Electric, 6, Wood.Alder, Wood.Alder);
            inventory.AddGuitar("V9512", 1549.95, Builder.Fender, "Stratocastor", GuitarType.Electric, 6, Wood.Alder, Wood.Alder);
        }
    }
}
